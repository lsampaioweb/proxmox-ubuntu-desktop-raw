...
Project with Terraform and Ansible scripts to create an Ubuntu Desktop template on Proxmox from a cloned virtual machine with the minimum packages and updates.
...
```bash
  ...
  05 - Create the necessary folders and files.
    ...
    module "proxmox-ubuntu-22-04" {
      ...
      description = "Ubuntu 22.04 VM with the minimum settings"
      pool        = "Stagging"
    }
